...
export type TicketUpdateRequestPriority = typeof TicketUpdateRequestPriority[keyof typeof TicketUpdateRequestPriority];


export const TicketUpdateRequestPriority = {
  CRITICAL: 'CRITICAL',
  HIGH: 'HIGH',
  MEDIUM: 'MEDIUM',
  LOW: 'LOW',
