 ...
 */
import type { FindBranchesByClientStatus } from './findBranchesByClientStatus';

export type FindBranchesByClientParams = {
/**
 * Filtro de status: ATIVO, INATIVO ou TODOS (padrão: TODOS)
 */
status?: FindBranchesByClientStatus;
};
